...
namespace UnityMidi
{
    ...
    public class MidiPlayer : MonoBehaviour
    {
        ...
        public void Awake(Synthesizer synth, MidiFileSequencer sequencer, AudioSource audioSource, StreamingAssetResouce bankSource, StreamingAssetResouce midiSource)
        {
